...
avg_nonsoc<-c(0,60)
avg_soc<-c(25,65)
ad_avg_nonsoc<-c(0,2,5,9,30,52,57,67)
ad_avg_soc<-c(12,48,4,41,48,33,57,59)
plot_da<-data.frame(avg_nonsoc,avg_soc)
plot_db<-data.frame(ad_avg_nonsoc,ad_avg_soc)

ggplot(plot_da)+geom_line(mapping = aes(avg_nonsoc,avg_soc))+geom_point(data =plot_db ,x=ad_avg_nonsoc,y=ad_avg_soc, size=.5)+theme_classic()
```
