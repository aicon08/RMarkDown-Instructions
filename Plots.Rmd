...
c<-ggplot(plot_da)+geom_line(mapping = aes(avg_nonsoc,avg_soc))+geom_point(data =plot_db ,x=ad_avg_nonsoc,y=ad_avg_soc, size=1)+theme_classic()+coord_cartesian(xlim = c(0,70),ylim = c(0,70))
